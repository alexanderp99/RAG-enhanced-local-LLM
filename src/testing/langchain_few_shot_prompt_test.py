...
print(llm.invoke(
    "Tell me if the following message is spam or not. You are only allowed to Respond with 'Is spam'. or i'is not spam'. Nothing else is allowed. Respond the the message: 'Hi, could you respond me with the latest meeting notes?'").content)
